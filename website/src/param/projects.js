module.exports = {
    1: {
        ...
        text1:"Riyadh is a city with both enormous amounts of traffic congestion and vast possibilities for pedestrian-focused urban design. Its ongoing public transportation development sug-gests a city invested in improving its walkability, while its current pedestrian zones are showcasing their successes with high amounts of social activity. Where can traffic calm-ing measures and street pedestrianization have the highest impacts in Riyadh, and how can data visualization help find these opportunities?",
        text2:"Using Twitter data as a proxy for potential pedestrian activity, mapped against car con-gestion data for Riyahd’s many highways and city streets, Pedestrian vs. Car visualizes densities of tweets versus densities of traffic in order to find zones of separation and overlap.",

    },
    2: {
        title:"Riyadh: Women on the Move",
        team:"Sin Bin Tan, MCP’17, Elaine Kim, MCP’17, Cortni Kerr, MCP’17",
        text1:"In Saudi Arabia, women are not allowed to drive. Instead they rely on personal drivers to get around the city. A public transport system could have a tremendous impact on the mobility of women. Riyadh, the Saudi Arabia’s capital city, is currently building an ex-tensive metro system, scheduled to be completed in 2018. The Women on the Move pro-ject seeks to understand the movements of women in Riyadh, and analyze how the pro-posed rail system will serve the places they travel.",
        text2:"The project created a sample population utilizing call detail records with origins and des-tinations at an all-women’s university. This analysis identifies where women travel before or after going to campus, potential paths, and the hotspots not served by the pro-posed rail system.",
